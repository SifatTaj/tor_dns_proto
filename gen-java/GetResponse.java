...
public class GetResponse implements org.apache.thrift.TBase<GetResponse, GetResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetResponse> {
  ...
  public GetResponse setAddress(String address) {
    this.address = address;
    return this;
  }
  ...
  public boolean equals(GetResponse that) {
    ...
    boolean this_present_address = true && this.isSetDns();
    boolean that_present_address = true && that.isSetDns();
  ...
  public int hashCode() {
    ...
    boolean present_address = true && (isSetDns());
  ...
  public int compareTo(GetResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetDns()).compareTo(other.isSetDns());
    if (lastComparison != 0) {
